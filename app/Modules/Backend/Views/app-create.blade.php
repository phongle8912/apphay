    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <div class="table-responsive">
          ...
          {!! Form::open(array('url' => URL('backend/app/store'), 'method' => 'POST', 'role' => 'form', 'files'=>true)) !!}
          ...
          <fieldset class="form-group">
           <?php echo Form::label('slug', 'Slug', array('class' => 'control-label col-sm-3'));?>
            <div class="col-sm-9">
            <?php echo Form::text('slug', old('Slug'), array('class'=>'form-control input-lg'));?>
          ...
          <fieldset class="form-group">
           <?php echo Form::label('keywords', 'Keywords', array('class' => 'control-label col-sm-3'));?>
            <div class="col-sm-9">
            <?php echo Form::text('keywords', old('Keywords'), array('class'=>'form-control input-lg'));?>
          ...
          <fieldset class="form-group">
           <?php echo Form::label('meta_desc', 'Meta Description', array('class' => 'control-label col-sm-3'));?>
            <div class="col-sm-9">
            <?php echo Form::text('meta_desc', old('Meta Description'), array('class'=>'form-control input-lg'));?>
          ...
          <fieldset class="form-group">
           <?php echo Form::label('short_description', 'Short Description', array('class' => 'control-label col-sm-3'));?>
            <div class="col-sm-9">
            <?php echo Form::text('short_description', old('Short Description'), array('class'=>'form-control input-lg'));?>
          ...
          <fieldset class="form-group">
           <?php echo Form::label('code', 'HTML Code', array('class' => 'control-label col-sm-3'));?>
            <div class="col-sm-9">
              {{ Form::textarea('code', old('code'), array('class' => 'form-control input-lg')) }}
